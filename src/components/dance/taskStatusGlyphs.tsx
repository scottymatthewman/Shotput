...
const byStatusHtml: Record<TaskStatus, string> = {
...
type TaskStatusGlyphProps = {
  status: TaskStatus
} & Pick<SVGProps<SVGSVGElement>, 'className' | 'aria-hidden'>

/** Task-status glyphs from `src/assets/StatusIcons`; colors follow `currentColor` for theming. */
