...
const badgeVariants = cva(
   'inline-flex items-center rounded-md px-2 py-0.5 text-xs font-medium transition-surface dance-focus-ring duration-150',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground',
        secondary: 'inset-edge-ring inset-edge-ring-full bg-secondary text-secondary-foreground',
